  ...
  return (
    ...
    >
      ...
      >
        ...
        {onToggleCollapse && !collapsed && (
          <button
            ...
            className='rounded-clean p-1.5 text-ink-faint transition-colors hover:bg-surface-2 hover:text-ink'
            title='收起目录'
          >
      ...
      {collapsed && onToggleCollapse && (
        <button
          onClick={onToggleCollapse}
          className='absolute -right-3 bottom-8 z-10 flex h-6 w-6 items-center justify-center rounded-full border border-ink-border bg-surface text-ink-faint shadow-sm transition-colors hover:bg-surface-2 hover:text-ink'
          title='展开目录'
        >
